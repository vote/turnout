    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_created_at', models.DateTimeField(null=True, db_column='foo_created_at')),
                ...
                ('new_state', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='foo_lead_new', to='election.State')),
                ('old_state', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='foo_lead_old', to='election.State')),
            ],
            options={
                'ordering': ['-created_at'],
                'db_table': 'integration_foolead',
            },
        ),
    ]
