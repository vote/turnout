...
class Registration(TrackingModel, UUIDModel, TimestampModel):
    ...
    state = models.ForeignKey(
        "election.State", on_delete=models.PROTECT, related_name="registration_primary"
    )
    ...
    previous_state = models.ForeignKey(
        "election.State", on_delete=models.PROTECT, related_name="registration_previous"
    )
    ...
    mailing_state = models.ForeignKey(
        "election.State", on_delete=models.PROTECT, related_name="registration_mailing"
    )
