    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(max_length=128, null=True, region=None, blank=True)),
                ...
                ('status', enumfields.fields.EnumField(default='Pending', enum=common.enums.TurnoutActionStatus, max_length=10, null=True)),
            ],
            options={
                'ordering': ['-created_at'],
            },
